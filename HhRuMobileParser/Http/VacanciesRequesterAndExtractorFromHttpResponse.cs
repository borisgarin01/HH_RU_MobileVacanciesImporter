...
namespace Models.Http
{
    public sealed class VacanciesRequesterAndExtractorFromHttpResponse
    {
        ...
        public async Task<IEnumerable<Item>> GetVacanciesResponseObjectViaHttpQuery(string text, string employment = "full", string schedule = "remote", string experience = "noExperience", int? areaId = null, string[] searchFields = null, int page = 0)
        {
